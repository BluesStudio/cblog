...
<div class="am-cf admin-main">
    ...
    <ul class="am-list admin-sidebar-list">
      ...
      <a class="am-cf" data-am-collapse="{target: '#collapse-nav3'}"><span class="am-icon-users"></span> 班级成员管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav3">
          ...
          <li class="admin-sidebar-list-hover"><a href="admin-members-add.html"><span class="am-icon-plus"></span> 添加成员</a></li>
  ...
  <form class="am-form am-form-horizontal" method="POST" action="/cblog/students/create">
    ...
    <div class="am-g">
      <div class="am-u-sm-12 am-u-md-4 am-u-md-push-8">
        <div class="am-panel am-panel-default">
          <div class="am-panel-bd">
            <div class="am-g">
              <div class="am-u-md-5">
                <img class="am-img-circle am-img-thumbnail" src="/cblog/img/class/members/1.jpg" alt=""/>
              </div>
              <div class="am-u-md-7">
                ...
                <button type="submit" class="am-btn am-btn-danger am-btn-sm">提交</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <select data-am-selected name="gender">
                ...
                <option value="man">男 / Boy</option>
                <option value="woman">女 / Girl</option>
              </select>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea class="" rows="5" id="user-intro" placeholder="座右铭将展示在班级成员页面/cblog." name="motto"></textarea>
