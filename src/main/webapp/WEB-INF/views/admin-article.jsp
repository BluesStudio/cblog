...
<div class="am-cf admin-main">
    ...
    <ul class="am-list admin-sidebar-list">
      ...
      <li class="admin-parent">
        ...
        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav1">
          <li class="admin-sidebar-list-hover"><a href="admin-article.html"><span class="am-icon-calendar"></span> 文章列表<span class="am-badge am-badge-secondary am-margin-right am-fr">13</span></a></li>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">班级文章</strong> / <small>article</small></div>
    </div>
