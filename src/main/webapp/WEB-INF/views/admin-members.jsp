...
<div class="am-cf admin-main">
    ...
    <ul class="am-list admin-sidebar-list">
      ...
      <a class="am-cf" data-am-collapse="{target: '#collapse-nav3'}"><span class="am-icon-users"></span> 班级成员管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav3">
          <li class="admin-sidebar-list-hover"><a href="admin-members.html"><span class="am-icon-calendar"></span> 成员列表<span class="am-badge am-badge-warning am-margin-right am-fr">27</span></a></li>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">班级成员</strong> / <small>members</small></div>
    </div>
    ...
    <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-6 am-margin gallery-list">
      <li>
      	 <header data-am-widget="header" class="am-header am-header-default admin-members-hd">
      	  <div class="am-header-left am-header-nav admin-members-hd-nav"><p><span class="am-icon-user"></span> 唐雪桃 </p></div>
        ...
        <a href="#">
          <img class="am-img-thumbnail am-img-bdrs admin-members-img" src="http://0401308.congm.in/images/members/1.jpg" alt=""/>
        </a>
      </li>
      <li>
         <header data-am-widget="header" class="am-header am-header-default admin-members-hd">
          <div class="am-header-left am-header-nav admin-members-hd-nav"><p><span class="am-icon-user"></span> 宋雯青 </p></div>
          <div class="am-dropdown am-header-right am-header-nav admin-members-hd-nav" data-am-dropdown>
            <div class="am-dropdown-toggle admin-members-hd-btn" data-am-dropdown-toggle><span class="am-icon-bars"></span></div>
            <ul class="am-dropdown-content admin-members-dd-ul">
              <li><a href="#" data-am-modal="{target: '#members-discuss'}"><span class="am-icon-check"></span> 查看评价</a></li>
        ...
        <a href="#">
          <img class="am-img-thumbnail am-img-bdrs admin-members-img" src="http://0401308.congm.in/images/members/2.jpg" alt=""/>
        </a>
      </li>
      <li>
         <header data-am-widget="header" class="am-header am-header-default admin-members-hd">
          <div class="am-header-left am-header-nav admin-members-hd-nav"><p><span class="am-icon-user"></span> 王梦 </p></div>
          <div class="am-dropdown am-header-right am-header-nav admin-members-hd-nav" data-am-dropdown>
            <div class="am-dropdown-toggle admin-members-hd-btn" data-am-dropdown-toggle><span class="am-icon-bars"></span></div>
            <ul class="am-dropdown-content admin-members-dd-ul">
              <li><a href="#" data-am-modal="{target: '#members-discuss'}"><span class="am-icon-check"></span> 查看评价</a></li>
        ...
        <a href="#">
          <img class="am-img-thumbnail am-img-bdrs admin-members-img" src="http://0401308.congm.in/images/members/3.jpg" alt=""/>
        </a>
      </li>
      <li>
         <header data-am-widget="header" class="am-header am-header-default admin-members-hd">
          <div class="am-header-left am-header-nav admin-members-hd-nav"><p><span class="am-icon-user"></span> 朱雯 </p></div>
          <div class="am-dropdown am-header-right am-header-nav admin-members-hd-nav" data-am-dropdown>
            <div class="am-dropdown-toggle admin-members-hd-btn" data-am-dropdown-toggle><span class="am-icon-bars"></span></div>
            <ul class="am-dropdown-content admin-members-dd-ul">
              <li><a href="#" data-am-modal="{target: '#members-discuss'}"><span class="am-icon-check"></span> 查看评价</a></li>
        ...
        <a href="#">
          <img class="am-img-thumbnail am-img-bdrs admin-members-img" src="http://0401308.congm.in/images/members/4.jpg" alt=""/>
        </a>
      </li>
      <li>
         <header data-am-widget="header" class="am-header am-header-default admin-members-hd">
          <div class="am-header-left am-header-nav admin-members-hd-nav"><p><span class="am-icon-user"></span> 谢丽佳 </p></div>
          <div class="am-dropdown am-header-right am-header-nav admin-members-hd-nav" data-am-dropdown>
            <div class="am-dropdown-toggle admin-members-hd-btn" data-am-dropdown-toggle><span class="am-icon-bars"></span></div>
            <ul class="am-dropdown-content admin-members-dd-ul">
              <li><a href="#" data-am-modal="{target: '#members-discuss'}"><span class="am-icon-check"></span> 查看评价</a></li>
        ...
        <a href="#">
          <img class="am-img-thumbnail am-img-bdrs admin-members-img" src="http://0401308.congm.in/images/members/5.jpg" alt=""/>
        </a>
      </li>
      <li>
         <header data-am-widget="header" class="am-header am-header-default admin-members-hd">
          <div class="am-header-left am-header-nav admin-members-hd-nav"><p><span class="am-icon-user"></span> 崔煜 </p></div>
          <div class="am-dropdown am-header-right am-header-nav admin-members-hd-nav" data-am-dropdown>
            <div class="am-dropdown-toggle admin-members-hd-btn" data-am-dropdown-toggle><span class="am-icon-bars"></span></div>
            <ul class="am-dropdown-content admin-members-dd-ul">
              <li><a href="#" data-am-modal="{target: '#members-discuss'}"><span class="am-icon-check"></span> 查看评价</a></li>
        ...
        <a href="#">
          <img class="am-img-thumbnail am-img-bdrs admin-members-img" src="http://0401308.congm.in/images/members/6.jpg" alt=""/>
        </a>
      </li>
      <li>
         <header data-am-widget="header" class="am-header am-header-default admin-members-hd">
          <div class="am-header-left am-header-nav admin-members-hd-nav"><p><span class="am-icon-user"></span> 王作众 </p></div>
          <div class="am-dropdown am-header-right am-header-nav admin-members-hd-nav" data-am-dropdown>
            <div class="am-dropdown-toggle admin-members-hd-btn" data-am-dropdown-toggle><span class="am-icon-bars"></span></div>
            <ul class="am-dropdown-content admin-members-dd-ul">
              <li><a href="#" data-am-modal="{target: '#members-discuss'}"><span class="am-icon-check"></span> 查看评价</a></li>
        ...
        <a href="#">
          <img class="am-img-thumbnail am-img-bdrs admin-members-img" src="http://0401308.congm.in/images/members/7.jpg" alt=""/>
        </a>
      </li>
      <li>
         <header data-am-widget="header" class="am-header am-header-default admin-members-hd">
          <div class="am-header-left am-header-nav admin-members-hd-nav"><p><span class="am-icon-user"></span> 吴易展 </p></div>
          <div class="am-dropdown am-header-right am-header-nav admin-members-hd-nav" data-am-dropdown>
            <div class="am-dropdown-toggle admin-members-hd-btn" data-am-dropdown-toggle><span class="am-icon-bars"></span></div>
            <ul class="am-dropdown-content admin-members-dd-ul">
              <li><a href="#" data-am-modal="{target: '#members-discuss'}"><span class="am-icon-check"></span> 查看评价</a></li>
        ...
        <a href="#">
          <img class="am-img-thumbnail am-img-bdrs admin-members-img" src="http://0401308.congm.in/images/members/8.jpg" alt=""/>
        </a>
      </li>
      <li>
         <header data-am-widget="header" class="am-header am-header-default admin-members-hd">
          <div class="am-header-left am-header-nav admin-members-hd-nav"><p><span class="am-icon-user"></span> 张程 </p></div>
          <div class="am-dropdown am-header-right am-header-nav admin-members-hd-nav" data-am-dropdown>
            <div class="am-dropdown-toggle admin-members-hd-btn" data-am-dropdown-toggle><span class="am-icon-bars"></span></div>
            <ul class="am-dropdown-content admin-members-dd-ul">
              <li><a href="#" data-am-modal="{target: '#members-discuss'}"><span class="am-icon-check"></span> 查看评价</a></li>
        ...
        <a href="#">
          <img class="am-img-thumbnail am-img-bdrs admin-members-img" src="http://0401308.congm.in/images/members/9.jpg" alt=""/>
        </a>
      </li>
