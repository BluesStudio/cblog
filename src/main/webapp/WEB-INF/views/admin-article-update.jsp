		...
		<div class="am-g">
	      <div class="am-input-group admin-article-input">
            ...
            <input type="hidden" name="id" value="${article.id }"/>
             <input type="text" class="am-form-field" placeholder="${article_id_required==null? (article_title_required==null? '文章标题':article_title_required):article_id_required }" name="title" value="${article.title }">
          </div>
