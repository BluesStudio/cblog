    ...
    <body>
        ...
        <div class="white_content">
            ...
            <div class="apply ibox" id="applyBox">
        		...
        		<!-- 表单2: 申请博客 -->
                <input type="text" name="" id="applyAdminName" class="login-input" value="" placeholder="管理员用户名">
                <input type="text" name="" id="applyClassName" class="login-input" value="" placeholder="班级名">
                <input type="password" name="" id="applyPassword" class="login-input" value="" placeholder="管理员密码">
                <input type="text" name="" id="applyCcap" class="login-input ccapInput" value="" placeholder="验证码">
            ...
            <div class="login ibox" id="loginBox">
                ...
                <input type="password" name="" id="userPassword" class="login-input" value="" placeholder="密码">
                <input type="text" name="" id="ccap" class="login-input ccapInput" value="" placeholder="验证码">
                <img class="ccap" src="/cblog/img/ccap.png" />
                <div class="login-button">
            ...
            <!-- 表单4: 注册 -->
                <input type="text" name="" id="userRegisterName" class="login-input" value="" placeholder="用户名">
                <input type="password" name="" id="userRegisterPassword" class="login-input" value="" placeholder="密码">
                <input type="text" name="" id="ccap" class="login-input ccapInput" value="" placeholder="验证码">
                <img class="ccap" src="/cblog/img/ccap.png" />
                <div class="login-button">
            ...
            <div class="adminlogin ibox" id="adminLoginBox">
                ...
                <!-- 表单5: 管理登录 -->
                <input type="text" name="" id="adminName" class="login-input" value="" placeholder="管理员用户名">
                <input type="password" name="" id="adminPassword" class="login-input" value="" placeholder="密码">
                <input type="text" name="" id="adminCcap" class="login-input ccapInput" value="" placeholder="验证码">
                <img class="ccap" src="/cblog/img/ccap.png" />
                <div class="login-button">
        ...
        <!-- handlebars -->
        <script id="more-item" type="text/x-handlebars-template">
            <ul>
                {{#articles}}
                <li class="cblog-more-box">
                    <div class="more-box-hd"><span class="more-box-bt"></span></div>
                    <a href="class-home.html" target="_blank"><div class="more-box-class">{{clazzId}}班 <i class="fa fa-rss"></i></div></a>
                    <a href="class-article.html" target="_blank"><p class="more-box-title">{{title}}</p></a>
                    <div class="more-box-time">{{activityDate}}</div>
        ...
        <script src="/cblog/js/index-async.js" type="text/javascript"></script>
        <script src="/cblog/js/handlebars.js" type="text/javascript"></script>
        <script type="text/javascript" charset="utf-8">
        $(function(){
            var source = $("#more-item").html();
            var template = Handlebars.compile(source);
            var cblog_more = $(".cblog-more");
            $.ajax({
                type: "POST",
                url: "/cblog/articles/list",
                dataType: "json",
                data: {
                    "sortFieldName": "activityDate"
                },
                success: function(data){
                    cblog_more.html(template(data));
                }
            });
            var logoimg = $("#logo");
            ...
            var clickToBox = function(btn, hash){
                btn.click(function(){
                    window.location.hash = hash;
                });
            };
            clickToBox(logoimg, "");
            clickToBox(iboxclose, "");
            clickToBox(toapplybox, "#adminRegister");
            clickToBox(tologinbox, "#userLogin");
            clickToBox(toregisterbox, "#userRegister");
            clickToBox(toadminloginbox, "#adminLogin");
            clickToBox(tomore, "#more");
            var logobox = $(".logo");
            var logotxt = $(".logo h1");
            var showBox = {
